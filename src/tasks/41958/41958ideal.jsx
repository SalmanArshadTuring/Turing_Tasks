...
const codingChallenges = [
  ...
  },
  {
    ...
    test: "userFunction([1, 5, 2, 9, 3]) === 9",
    explanation:
      "This solution uses the spread operator with Math.max() to find the largest number in the array.",
  },
];
...
export default function App() {
  ...
  const handleSubmit = useCallback(() => {
    try {
      ...
      // Dynamically create a test evaluator
      const testFunction = new Function(
        `const userFunction = ${userCode}; return ${currentChallenge.test};`
      );
